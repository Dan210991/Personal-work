...
/////////////////////////////////////////// MAIN MENU OPTION 3
      ...
      case 3: {
        ...
        JFrame f = new JFrame("Rules by Daniel Pusey");
...
/////////////////////////////////////////// MAIN MENU OPTION 4
      ...
      case 4:	{
    	  int index = (int) (Math.random() * (Barking.parrot.length / 3));
	      String what = Barking.parrot[index * 3];
	      String who = Barking.parrot[1 + index * 3];
