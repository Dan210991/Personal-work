...
public class List05
{
	public static void main(String[] args) {
		...
		System.out.println("Accuracy stats for weapons");
		
		System.out.println("Sorted by Comparator in Weapon class");
	    ...
	    table.stream()
	         .sorted((c1, c2) -> 
	            ((Float) c1.getAccuracy()).compareTo(c2.getAccuracy()))
	         .forEach(System.out::println);
	}
}

/***
This class sorts the list firstly based on the comparative method in Weapon.java and secondly by using Lambda
***/