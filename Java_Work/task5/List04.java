...
public class List04
{
	public static void main(String[] args) {
		List<Weapon> table = Arrays.asList(
			...
			new Weapon("9x19", "Saiga-9", "Kalashnikov Concern", (float) 2.41, 55, 305, 32, 650, 300, "Single", true, false),
		...
		System.out.println("Several weapons listed have been made by Kalashnikov Concern");
	    table.stream().filter(club -> club.getManufacturer() == "Kalashnikov Concern")
	        .forEach(System.out::println);

	    System.out.println();
	    System.out.println("Functionable weapons made by Kalashnikov Concern");
	    table.stream().filter(club -> club.getFunctional() == true && club.getManufacturer() == "Kalashnikov Concern")
	        .forEach(System.out::println);
	}
}

/***
This class looks through the list of data and finds any weapon with the manufacturer "Kalashnikov Concern", any weapons that are matching
this manufacturer name and are functional will be returned.
***/